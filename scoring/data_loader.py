...
def load_matrix(path: Path) -> pd.DataFrame:
    ...
    try:
        ...
        raise pd.errors.EmptyDataError("The CSV file is empty") from None
    except UnicodeDecodeError as e:
        raise ValueError(f"Unable to decode CSV file. Ensure it's a valid CSV file. Error: {e}") from e
    ...
    try:
        ...
        df["EmphMod"] = df["Requirement"].apply(lambda text: emphasis_modifier(text, SCORING_CONFIG))
